...
const LatestCollection = () => {
  ...
  return (
    <div className='my-10 px-4 sm: px-[5vw] md: px-[7vw] lg: px-[2vw]'>
      ...
      <div className='flex justify-center items-center min-h-screen'>
        <div className='w-full sm:w-4/5 grid grid-cols-2 sm:grid-cols-3 md:grids-cols-4 lg:grid-cols-5 gap-4 gap-y-6'>
