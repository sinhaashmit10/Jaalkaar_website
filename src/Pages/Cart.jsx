...
const Cart = () => {
  ...
  return (
    <div className='border-t p-14'>
      ...
      <div className='w-full sm:w-[450px] border'>
        <CartTotal/>
        <div className='w-full text-center'>
          <button onClick={() => navigate('/place-order')} className='bg-[#800020] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-[#800020] transition text-sm my-8 px-8 py-3'>PROCEED TO CHECKOUT</button>
        </div>
      </div>
    </div>
    </div>
