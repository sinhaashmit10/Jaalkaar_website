  ...
  return (
    ...
    <div className="bg-[#D4AF37]">
      <div className="flex flex-col lg:flex-row gap-12 items-center justify-center lg:gap-8 transition-all">
        {/* Text Section */}
        <div className='flex flex-col'>
          <h1 className='text-[#800020] mt-14 lg:mt-0 px-4 text-2xl'>Empowering Local Artisans</h1>
          <p className="text-justify text-black px-4 lg:w-[30rem] mt-4 hover:text-white transition-colors duration-300">
    ...
    <div className="bg-[#D4AF37]">
      <div className="flex flex-col lg:flex-row gap-12 items-center justify-center lg:gap-8 transition-all">
        {/* Text Section */}
        <div className='flex flex-col'>
          <h1 className='text-[#800020] mt-14 lg:mt-0 px-4 text-2xl'>Celebrating Bihar’s Heritage</h1>
          <p className="text-justify text-black px-4 lg:w-[30rem] mt-4 hover:text-white transition-colors duration-300">
